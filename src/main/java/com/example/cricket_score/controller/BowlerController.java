...
//
//
    @PostMapping("/bowler-save")
    public String save(@ModelAttribute Bowler bowler, Model model, RedirectAttributes redirectAttributes){
       int run=  bowlerService.updateScore(bowler);
